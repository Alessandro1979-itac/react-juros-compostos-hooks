...
export default function App() {
  ...
  const calculateInterest = (initialValue, setMonthlyInterest, monthlyPeriod) => {
    ...
    for(let i = 1; i <= monthlyPeriod; i++) {
      const percentValue = (currentValue * Math.abs(setMonthlyInterest)) / 100;

      currentValue = monthlyInterest >= 0
